...
set "PROJECT_CLASSES=%BUILD_DIR%\frontoffice-classes"
...
cd "%PROJECT_BUILD%"
jar cf "%BUILD_DIR%\frontoffice-0.0.1-SNAPSHOT.war" *
cd "%PROJECT_DIR%"
...
copy "%BUILD_DIR%\frontoffice-0.0.1-SNAPSHOT.war" "%CATALINA_HOME%\webapps" /Y >nul
